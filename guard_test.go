...
func TestCheckOrderValue(t *testing.T) {
	...
	t.Run("over limit blocked", func(t *testing.T) {
		...
		assert.Equal(t, ReasonOrderValue, r.Reason, "TestCheckOrderValue: want=%v got=%v", ReasonOrderValue, r.Reason)
	})
...
func TestCheckQuantityLimit(t *testing.T) {
	...
	t.Run("under freeze qty passes", func(t *testing.T) {
		...
		assert.True(t, r.Allowed, "TestCheckQuantityLimit: r.Allowed")
	})
	...
	t.Run("over freeze qty blocked", func(t *testing.T) {
		...
		assert.False(t, r.Allowed, "TestCheckQuantityLimit: r.Allowed")
		assert.Equal(t, ReasonQuantityLimit, r.Reason, "TestCheckQuantityLimit: want=%v got=%v", ReasonQuantityLimit, r.Reason)
	})
...
func TestRecordOrder(t *testing.T) {
	...
	assert.Equal(t, 2, count, "TestRecordOrder: want=%v got=%v", 2, count)
}
...
func TestGetEffectiveLimits(t *testing.T) {
	...
	t.Run("returns system defaults for unknown user", func(t *testing.T) {
		...
		assert.Equal(t, SystemDefaults.MaxSingleOrderINR, l.MaxSingleOrderINR, "TestGetEffectiveLimits: want=%v got=%v", SystemDefaults.MaxSingleOrderINR, l.MaxSingleOrderINR)
		assert.Equal(t, SystemDefaults.MaxOrdersPerDay, l.MaxOrdersPerDay, "TestGetEffectiveLimits: want=%v got=%v", SystemDefaults.MaxOrdersPerDay, l.MaxOrdersPerDay)
	})
